    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post(
                '/api/v1/auth/register', {name, email, password, phone, address, answer}
            )
    ...
    <Layout title="Register - Ecommerce App">
        <div className='form-container'>
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    <input type="text" value={answer} onChange={(e) => setAnswer(e.target.value)} className="form-control" id="exampleInputEmail1" placeholder='What is your favorite animal' required/>
                </div>
